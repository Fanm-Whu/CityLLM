...
@author: 樊明
@date: start: 2025-12-05; end: 2025-12-05
       start: 2025-12-13; end: 2025-12-14
@version: 1.1
"""
...
class TestTaskDecomposerAgent:
    ...
    def listStrInitTestData(self):
        testDataListstr = [
            # 需要分解的复杂查询 - 10个
            "模拟2021年武汉市土地利用状况，并展示出2018年武汉市土地利用状况，我想作对比",
...
def main():
    ...
    additional_tests = [
        ...
        "模拟2020年中部六省的土地利用情况，并展示2020年中部六省的土地利用数据",
        "模拟2021-2023年长三角地区的土地利用情况，并展示2021年-2023年长三角的土地利用数据",
        "模拟2021年到2025年武汉市、广州市土地利用状况",
        "模拟2021年到2025年武汉市土地利用状况",
        "模拟2021年-2025年武汉市土地利用状况",
        "预测2025年北京和上海的城市扩张",
        "展示数据",
        "分别考虑",
        "这是一个不需要分解的简单任务",
        "模拟2021年武汉市土地利用状况，并展示2018年数据，预测2025年城市扩张"
    ]
