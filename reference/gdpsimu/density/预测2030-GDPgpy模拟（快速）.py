...
dataset2 = gdal.Open(r'C:\Users\Zhongym\Desktop\多要素强耦合模型\操作数据\GDP_2020_pre_Normalized.tif')
GDP_pre= dataset2.GetRasterBand(1).ReadAsArray().astype(float)
...
output_file = r'C:\Users\Zhongym\Desktop\多要素强耦合模型\实验结果\GPY预测GDP密度_2030快速.tif'
