...
density_path = r'C:\Users\Zhongym\Desktop\多要素强耦合模型\实验结果\GPY预测GDP密度_2025缓慢.tif'
...
breaks = [0,100,300,500,800,1000,1500,2000,2714]
density_break=[0.15625033,0.203389367,0.256514939,0.300682368,0.325891655,0.360545895,0.453048183,1]
...
def allocate_population(density, density_break, max_increase,Total_tolerance_error=max_increase*0.05):
    ...
    df_error_values.to_excel(r'C:\Users\Zhongym\Desktop\多要素强耦合模型\输出文档和图\error_values_GDP_2025_缓慢.xlsx', index=False)
    ...
    plt.savefig(r'C:\Users\Zhongym\Desktop\多要素强耦合模型\输出文档和图\error_values_GDP_2025缓慢.png')
    plt.show()
...
output_file = r'C:\Users\Zhongym\Desktop\多要素强耦合模型\实验结果\final_allocated_gdp_2025缓慢2.tif'
