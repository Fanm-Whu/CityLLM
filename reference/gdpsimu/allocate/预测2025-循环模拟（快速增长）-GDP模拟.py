...
dataset3 = gdal.Open(r'C:\Users\Zhongym\Desktop\多要素强耦合模型\实验结果\2025年土地功能模拟结果_快速.tif')
land = dataset3.GetRasterBand(1).ReadAsArray().astype(float)
data_path = r'C:\Users\Zhongym\Desktop\多要素强耦合模型\操作数据\GDP2019_wuha.tif'
density_path = r'C:\Users\Zhongym\Desktop\多要素强耦合模型\实验结果\GPY预测GDP密度_2025快速.tif'
...
max_increase = 204590298
breaks =   [0,20,50,100,300,500,1000,1500,2714]
# density_break=[0.197625033,0.303389367,0.326514939,0.350682368,0.405891655,0.460545895,0.563048183,1]
density_break=[0.157625033,0.263389367,0.326514939,0.350682368,0.405891655,0.460545895,0.563048183,1]
...
def allocate_population(density, density_break, max_increase,Total_tolerance_error=max_increase*0.05):
    ...
    df_error_values.to_excel(r'C:\Users\Zhongym\Desktop\多要素强耦合模型\输出文档和图\error_values_GDP_2025_快速.xlsx', index=False)
    ...
    plt.savefig(r'C:\Users\Zhongym\Desktop\多要素强耦合模型\输出文档和图\error_values_GDP_2025快速.png')
    plt.show()
...
output_file = r'C:\Users\Zhongym\Desktop\多要素强耦合模型\实验结果\final_allocated_gdp_2025快速2.tif'
