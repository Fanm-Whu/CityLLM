...
dataset3 = gdal.Open(r'C:\Users\Zhongym\Desktop\多要素强耦合模型\实验结果\2030年土地功能模拟结果_快速.tif')
land = dataset3.GetRasterBand(1).ReadAsArray().astype(float)
data_path = r'C:\Users\Zhongym\Desktop\多要素强耦合模型\操作数据\GDP2019_wuha.tif'
density_path = r'C:\Users\Zhongym\Desktop\多要素强耦合模型\实验结果\GPY预测GDP密度_2030快速.tif'
...
density_break=[0.197625033,0.363389367,0.406514939,0.450682368,0.505891655,0.560545895,0.663048183,1]
...
def allocate_population(density, density_break, max_increase,Total_tolerance_error=max_increase*0.05):
    ...
    df_error_values.to_excel(r'C:\Users\Zhongym\Desktop\多要素强耦合模型\输出文档和图\error_values_GDP_2030_快速.xlsx', index=False)
    ...
    plt.savefig(r'C:\Users\Zhongym\Desktop\多要素强耦合模型\输出文档和图\error_values_GDP_2030快速.png')
    plt.show()
...
output_file = r'C:\Users\Zhongym\Desktop\多要素强耦合模型\实验结果\final_allocated_gdp_2030快速.tif'
