...
density_path = r'C:\Users\Zhongym\Desktop\多要素强耦合模型\实验结果\GPY预测人口密度_2025自然.tif'
...
breaks =  [1,5,20,50,150,250,350,450,530]
density_break= [0.1364, 0.2893, 0.3592, 0.4072, 0.6592, 0.6847, 0.7872, 1]
...
def allocate_population(density, density_break, class_means, max_increase,Total_tolerance_error=max_increase*0.05):
    ...
    df_error_values.to_excel(r'C:\Users\Zhongym\Desktop\多要素强耦合模型\输出文档和图\error_values_2025_pop自然.xlsx', index=False)
    ...
    plt.savefig(r'C:\Users\Zhongym\Desktop\多要素强耦合模型\输出文档和图\error_values_2025_pop自然.png')
    plt.show()
...
output_file = r'C:\Users\Zhongym\Desktop\多要素强耦合模型\实验结果\final_allocated_population_2025自然.tif'
