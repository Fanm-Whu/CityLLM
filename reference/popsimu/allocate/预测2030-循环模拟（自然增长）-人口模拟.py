...
density_path = r'C:\Users\Zhongym\Desktop\多要素强耦合模型\实验结果\GPY预测人口密度_2030自然.tif'
...
density_break=[0.2364, 0.4093, 0.4592, 0.5172, 0.5792, 0.6247, 0.6772, 1]
...
def allocate_population(density, density_break, class_means, max_increase,Total_tolerance_error=max_increase*0.05):
    ...
    df_error_values.to_excel(r'C:\Users\Zhongym\Desktop\多要素强耦合模型\输出文档和图\error_values_2030_pop自然.xlsx', index=False)
    ...
    plt.savefig(r'C:\Users\Zhongym\Desktop\多要素强耦合模型\输出文档和图\error_values_2030_pop自然.png')
    plt.show()
...
output_file = r'C:\Users\Zhongym\Desktop\多要素强耦合模型\实验结果\final_allocated_population_2030自然.tif'
